...
class StudentLessonsSearch extends LessonsSearch
{
    /**
     * @inheritdoc
     */
       ...
       protected function addCondition($query, $attribute, $partialMatch = false)
{
    ...
    $inLessons = StudentsInLesson::findAll(['student_id' => $student->id]);
    $ids = [];       
      foreach ($inLessons as $value) {
        array_push($ids, $value['lesson_id']);
     }
    $query->having(['id' => $ids]);
